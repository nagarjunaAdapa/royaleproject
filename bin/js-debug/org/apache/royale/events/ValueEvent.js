...
org.apache.royale.events.ValueEvent.prototype.ROYALE_REFLECTION_INFO = function () {
  return {
    ...
    methods: function () {
      return {
        'ValueEvent': { type: '', declaredBy: 'org.apache.royale.events.ValueEvent', parameters: function () { return [ { index: 1, type: 'String', optional: false },{ index: 2, type: '*', optional: true },{ index: 3, type: 'Boolean', optional: true },{ index: 4, type: 'Boolean', optional: true } ]; }},
 ...
 * @type {number}
 */
org.apache.royale.events.ValueEvent.prototype.ROYALE_REFLECTION_INFO.compileFlags = 10;
